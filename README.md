...
1.  **Include the Package:** (choose only *i.* or *ii.*)
    ...
    ***i***. From *CTAN*
    ...
    > Please note that it can take a while for ctan to process a new update. Same goes for Tex live and MiKTeX. Note also, that MiKTeX is running behind updating from mirror servers. Therefore you might consider using it locally.
